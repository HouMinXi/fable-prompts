...
<!-- anthropic_reminders REMOVED [RESEARCHED]: Anthropic reminders/classifiers are delivered only by Anthropic infra to claude.ai sessions, not via a CLI system prompt. Behavioral safety stays via refusal_handling + harmful_content_safety. -->
